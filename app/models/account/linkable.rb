module Account::Linkable
  ...
  included do
    ...
    belongs_to :klutch_account, optional: true
  end

  # A "linked" account gets transaction and balance data from a third party like Plaid, SimpleFIN, or Klutch
  def linked?
    plaid_account_id.present? || simplefin_account_id.present? || klutch_account_id.present?
  end
